...
class FileOperation{
    ...
    boolean newFileFlag;
    String fileName;
    String applicationTitle = "My Notepad";
    File fileRef;
    ...
    FileOperation(Notepad npd){
        ...
        chooser.setCurrentDirectory(new File("D:\\Sumit\\Java\\CJM\\SwingExample\\src\\com\\sumit\\notepad\\Data\\"));
    }
    /////////////////////////////////////////////////////////////////
    ...
    boolean saveAsFile(){
        ...
        chooser.setApproveButtonToolTipText("Click here to save");
        ...
        do{
            ...
            if(JOptionPane.showConfirmDialog(this.npd.f, "<html>" + temp.getPath() + " already exists.<br> Do you want to replace it? </html>", "Save As", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                break;
            }
        }while (true);
